    ...
    <>
      ...
      <div className="button-list">
          ...
          i.display_status && (
            <li key={index}>
              ...
              >
                ...
                />
                <div className="daily-text"> {i.donation_head_id} {i.head_name}</div>
        ...
        {selectedItem !== null && selectedItem !== 'other' && (
          <div className='mt-2'>
            <strong style={{ fontSize: '15px' }}>{selectedItem === 'other' ? 'other' : headsData[selectedItem]?.head_name} : </strong>
            <input
              type="number"
